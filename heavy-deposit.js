(function(){
  function setup(){
    ...
    if(type&&!type.querySelector('option[value="Heavy Deposit"]')){var o=document.createElement('option');o.value='Heavy Deposit';o.setAttribute('data-hd-key','heavyDeposit');type.appendChild(o)}
    update();
  }
  ...
  window.addEventListener('load',setup);setup();var l=document.getElementById('lang');if(l)l.addEventListener('change',function(){setTimeout(update,0)});
})();