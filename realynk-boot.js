...
function start(){
  ...
  load('./realynk-admin-entry.js?v=1','realynkAdminEntry',false);
  document.addEventListener('click',function(e){
    ...
    if(nav&&nav.getAttribute('data-nav')==='account')load('./super-admin.js?v=3','realynkSuperAdmin',true);
