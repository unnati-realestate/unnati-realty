...
function start(){
 ...
 load('./realynk-deal-fields.js?v=5','realynkDealFieldsV4',true);load('./realynk-bulk-property.js?v=14','realynkBulkPropertyV1',true);
