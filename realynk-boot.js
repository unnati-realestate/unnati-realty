/* REALYNK SAFE BOOT V50 — production-stable category navigation + cache-safe assets */
(function(){
'use strict';
if(window.__REALYNK_SAFE_BOOT_V50__)return;
window.__REALYNK_SAFE_BOOT_V50__=true;
