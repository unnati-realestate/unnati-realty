/* REALYNK SAFE BOOT V72 — cloud-first property core */
(function(){
'use strict';
if(window.__REALYNK_SAFE_BOOT_V72__)return;window.__REALYNK_SAFE_BOOT_V72__=true;
...
if(nav&&nav.getAttribute('data-nav')==='dashboard'){load('./realynk-property-actions.js?v=8','realynkPropertyActions',false);load('./realynk-status-actions.js?v=3','realynkStatusActions',false)}
