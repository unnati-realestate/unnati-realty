/* REALYNK SAFE BOOT V78 — cloud-first property core */
(function(){
'use strict';
if(window.__REALYNK_SAFE_BOOT_V78__)return;window.__REALYNK_SAFE_BOOT_V78__=true;
...
if(nav&&nav.getAttribute('data-nav')==='dashboard'){load('./realynk-property-actions.js?v=8','realynkPropertyActions',false);load('./realynk-status-actions.js?v=3','realynkStatusActions',false);load('./realynk-broker-dashboard.js?v=1','realynkBrokerDashboardV1',false)}
