/* REALYNK SAFE BOOT V80 — cloud-first property core + visible broker earning */
(function(){
'use strict';
if(window.__REALYNK_SAFE_BOOT_V80__)return;window.__REALYNK_SAFE_BOOT_V80__=true;
