/* REALYNK SAFE BOOT V36 — deferred startup to prevent browser/PWA freezes */
(function(){
'use strict';
if(window.__REALYNK_SAFE_BOOT_V36__)return;
window.__REALYNK_SAFE_BOOT_V36__=true;
...
function start(){
 ...
 idle(function(){
  ...
  load('./realynk-property-filter.js?v=7','realynkPropertyFilter',false);
