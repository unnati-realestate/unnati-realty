/* REALYNK SAFE BOOT V34 — deferred startup to prevent browser/PWA freezes */
(function(){
'use strict';
if(window.__REALYNK_SAFE_BOOT_V34__)return;
window.__REALYNK_SAFE_BOOT_V34__=true;
function load(src,key,module){
  if(window[key])return;
  var s=document.createElement('script');s.src=src;s.async=true;if(module)s.type='module';document.head.appendChild(s);
}
...
function start(){
  ...
  idle(function(){
    ...
    load('./realynk-property-filter.js?v=5','realynkPropertyFilter',false);
    load('./realynk-heavy-deposit.js?v=4','realynkHeavyDeposit',false);
  ...
  document.addEventListener('click',function(e){
    ...
    if(nav&&nav.getAttribute('data-nav')==='dashboard')load('./realynk-property-actions.js?v=1','realynkPropertyActions',false);
