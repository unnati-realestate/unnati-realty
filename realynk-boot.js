/* REALYNK SAFE BOOT V59 — production property cloud restore + authoritative broker verification UI */
(function(){
'use strict';
if(window.__REALYNK_SAFE_BOOT_V59__)return;
window.__REALYNK_SAFE_BOOT_V59__=true;
