/* REALYNK SAFE BOOT V35 — deferred startup to prevent browser/PWA freezes */
(function(){
'use strict';
if(window.__REALYNK_SAFE_BOOT_V35__)return;
window.__REALYNK_SAFE_BOOT_V35__=true;
...
function start(){
 ...
 idle(function(){
  ...
  load('./realynk-property-filter.js?v=6','realynkPropertyFilter',false);
  load('./realynk-heavy-deposit.js?v=5','realynkHeavyDeposit',false);
