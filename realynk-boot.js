/* REALYNK SAFE BOOT V45 — digital card + status management + business WhatsApp */
(function(){
'use strict';
if(window.__REALYNK_SAFE_BOOT_V45__)return;
window.__REALYNK_SAFE_BOOT_V45__=true;
...
function start(){
 ...
 document.addEventListener('click',function(e){
  ...
  if(nav&&nav.getAttribute('data-nav')==='dashboard'){load('./realynk-property-actions.js?v=4','realynkPropertyActions',false);load('./realynk-status-actions.js?v=1','realynkStatusActions',false)}
