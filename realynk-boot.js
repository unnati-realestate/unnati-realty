...
function start(){
 ...
 load('./realynk-stability.js?v=30','realynkStabilityV20',true,true);
 ...
 idle(function(){load('./firebase-auth.js?v=24','realynkAuthEntryV24',false);load('./realynk-media.js?v=5','realynkMedia',false);load('./realynk-heavy-deposit-type.js?v=3','realynkHeavyDepositType',false);load('./realynk-public-actions.js?v=5','realynkPublicActions',false);load('./realynk-property-card.js?v=2','realynkPropertyCardV1',false);load('./realynk-broker-share-card.js?v=4','realynkRefreshBrokerShareCard',false);load('./realynk-requirements-v3.js?v=1','realynkRequirements',false);load('./realynk-broker-invite.js?v=19','realynkBrokerInviteV13',false);load('./realynk-broker-verification-sync.js?v=4','realynkBrokerVerificationSyncV4',true);load('./realynk-list-dedupe.js?v=1','realynkListDedupeV1',false);load('./realynk-bulk-broker-import.js?v=11','realynkBulkBrokerImportV3',false);load('./realynk-bulk-whatsapp.js?v=4','realynkBulkWhatsAppV4',false);load('./realynk-digital-card.js?v=15','realynkDigitalCardV11',false)},300);
 document.addEventListener('click',function(e){var nav=e.target.closest('[data-nav]');if(nav&&nav.getAttribute('data-nav')==='brokers'){load('./realynk-broker-auth.js?v=7','realynkBrokerAuthV7',true);load('./realynk-professional-profile.js?v=2','realynkProfessionalProfile',false);load('./realynk-broker-share-card.js?v=4','realynkRefreshBrokerShareCard',false);load('./realynk-broker-invite.js?v=19','realynkBrokerInvite',false);load('./realynk-bulk-broker-import.js?v=5','realynkBulkBrokerImportV3',false)}if(nav&&nav.getAttribute('data-nav')==='dashboard'){load('./realynk-broker-dashboard.js?v=1','realynkBrokerDashboardV1',false);load('./realynk-broker-earning.js?v=5','realynkBrokerEarningV3',false)}if(nav&&nav.getAttribute('data-nav')==='account'){load('./realynk-broker-auth.js?v=7','realynkBrokerAuthV7',true);load('./realynk-digital-card.js?v=11','realynkDigitalCardV11',false);load('./realynk-verification-sync.js?v=4','realynkBrokerVerificationSyncV4',true)}if(e.target.closest('#postQuick,#brokerPost,#add'))load('./realynk-video-replace.js?v=1','realynkVideoReplace',false)},true);
 idle(function(){load('./realynk-admin-entry.js?v=9','realynkAdminEntry',true)},2200)
}
