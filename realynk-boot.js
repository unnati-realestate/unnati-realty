/* REALYNK SAFE BOOT V52 — production-stable category navigation + requirements + broker invite */
(function(){
'use strict';
if(window.__REALYNK_SAFE_BOOT_V52__)return;
window.__REALYNK_SAFE_BOOT_V52__=true;
