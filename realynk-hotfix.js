/* REALYNK HOTFIX V2 - one Firebase property feed, working category/contact/share buttons. */
...
function bind(){
  ...
  [["buy","Buy"],["sale","Sale"],["rent","Rent"],["commercial","Commercial"],["heavyDeposit","Heavy Deposit"]].forEach(([id,v])=>$(id)?.addEventListener("click",e=>{stop(e);show("home");filter=v;render()},true));
