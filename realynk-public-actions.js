/* REALYNK PUBLIC PROPERTY ACTIONS V5 — official business WhatsApp sharing */
(function(){
'use strict';
if(window.__REALYNK_PUBLIC_ACTIONS_V5__)return;
window.__REALYNK_PUBLIC_ACTIONS_V5__=true;
...
btn('🔗 Share on WhatsApp',function(){window.open(wa('🏠 Check this property on Realynk:\n'+title+'\n\n'+propertyUrl()),'_blank')},'share');
