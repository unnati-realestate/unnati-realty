/* REALYNK AUTH ENTRY V20 — stable catalog, property rows and mobile filters */
(function(){
'use strict';
if(window.__REALYNK_AUTH_ENTRY_V20__)return;window.__REALYNK_AUTH_ENTRY_V20__=true;
...
load('./realynk-property-display.js?v=9','realynkPropertyDisplay',false);
load('./realynk-category-filter.js?v=22','realynkCategoryFilter',false);
})();
