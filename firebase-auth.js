/* REALYNK AUTH ENTRY V10 — current property catalog/display + mobile-safe filters */
(function(){
'use strict';
if(window.__REALYNK_AUTH_ENTRY_V10__)return;
window.__REALYNK_AUTH_ENTRY_V10__=true;
...
load('./realynk-property-display.js?v=3','realynkPropertyDisplay',false);
