/* REALYNK AUTH ENTRY V15 — single-loader public catalog + property rows + mobile filters */
(function(){
'use strict';
if(window.__REALYNK_AUTH_ENTRY_V15__)return;window.__REALYNK_AUTH_ENTRY_V15__=true;
...
load('./realynk-property-display.js?v=6','realynkPropertyDisplay',false);
load('./realynk-category-filter.js?v=19','realynkCategoryFilter',false);
})();
